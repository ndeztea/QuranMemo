var QuranJS = {
    ...
    */
	...
	showInfoMemoz : function (){
		...
		$('.modal-body').html('<p>Dalam proses hafalan terdapat 5 tahapan, yaitu: </p><br><ul><li> Hafalkan dengan teliti target hafalan arabic dan terjemahannya, ulangi muratal sebanyak-banyaknya sampai hafal</li><li>Hafalkan dengan teliti target hafalan arabic, baca dengan keras hafalan arabic nya dan hitung berapa kali antum membacanya</li><li>Fokuskan hafalan terjemahannya saja</li><li>TEST...!! Bacakan setiap kata yang di hilangkan.</li><li>PUZZLE...!! Cocokan kata yang hilang secara berurutan</li></ul><br><p>Jangan lupa untuk berdo\'a kepada Allah Ta\'ala untuk di mudahkan dalam penghafalan dan pemahaman terhadap target hafalan antum.</p><p>Kunci untuk mengafal adalah <strong>ulangi dan terus ulangi</strong> membaca dan mendengarkan muratal.');
