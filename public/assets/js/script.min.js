var QuranJS = {
	...
	modalLoadingBlockRemove : function(){
		//$('.modal-body').append('loading');
	},
	...
	stepMemoz : function(steps,flag=''){
		$('.mushaf-hafalan').addClass('step-1');
		$('.mushaf-hafalan').addClass('step-2');
		$('.mushaf-hafalan').addClass('step-3');
		$('.mushaf-hafalan').addClass('step-4');
		$('.mushaf-hafalan').addClass('step-5');
		...
		if(steps==1){
			...
			//jQuery('.trans').removeClass('puff').removeClass('go');
			//jQuery('.arabic').removeClass('puff').removeClass('go');
			jQuery('.steps_desc p').html('<i class="fa fa-info-circle"></i> TEST...!! Bacakan dan rekam setiap kata yang di hilangkan.');
			jQuery('.jp-stop').click();
		...
		}else if(steps=='correction'){
			this.stepMemoz(4);
			jQuery('.quran_player').hide();

			if(flag!=''){
				jQuery('.steps_desc p').html('<i class="fa fa-info-circle"></i> Cek hafalan ayat yang berwarna kuning dan perbaiki hafalanya');
			}else{
				jQuery('.steps_desc p').html('<i class="fa fa-info-circle"></i> Cek rekaman suara, dan tandai ayat yang kurang tepat.');
			}
			
			jQuery('.steps_1, .steps_2, .steps_3, .steps_5').addClass('disabled');
			jQuery('.quran_player').hide();

			jQuery('.steps_4').addClass('selected');
		}
