var QuranJS = {
    ...
    tajwidHighlight: function() {
        ...
        for (i = 0; i < a.length; i++){
          console.log("ن" + a[i])
           jQuery(".arabic").highlight("نْ" + a[i], "highlight-orange tajwid"), $(".arabic").highlight("ن " + a[i], "highlight-orange tajwid"), $(".arabic").highlight("ً " + a[i], "highlight-orange tajwid tanwin1"), $(".arabic").highlight("ً" + a[i], "highlight-orange tajwid tanwin1"), $(".arabic").highlight("ٌ " + a[i], "highlight-orange tajwid tanwin1"), $(".arabic").highlight("ٌ" + a[i], "highlight-orange tajwid tanwin1"), $(".arabic").highlight("ٍ " + a[i], "highlight-orange tajwid tanwin2"), $(".arabic").highlight("ٍ" + a[i], "highlight-orange tajwid tanwin2");
        }
        var e = ["ي", "ن", "م", "و", "ل", "ر"];
        for (i = 0; i < e.length; i++) $(".arabic").highlight("نْ" + e[i], "highlight-blue tajwid"), $(".arabic").highlight("ن " + e[i], "highlight-blue tajwid"), $(".arabic").highlight("ً " + e[i], "highlight-blue tajwid tanwin1"), $(".arabic").highlight("ً" + e[i], "highlight-blue tajwid tanwin1"), $(".arabic").highlight("ٌ " + e[i], "highlight-blue tajwid tanwin1"), $(".arabic").highlight("ٌ" + e[i], "highlight-blue tajwid tanwin1"), $(".arabic").highlight("ٍ " + e[i], "highlight-blue tajwid tanwin2"), $(".arabic").highlight("ٍ" + e[i], "highlight-blue tajwid tanwin2");
        var t = ["ب"];
        for (i = 0; i < t.length; i++) $(".arabic").highlight("نْ" + t[i], "highlight-green tajwid"), $(".arabic").highlight("ن " + t[i], "highlight-green tajwid"), $(".arabic").highlight("ً " + t[i], "highlight-green tajwid tanwin1"), $(".arabic").highlight("ً" + t[i], "highlight-green tajwid tanwin1"), $(".arabic").highlight("ٌ " + t[i], "highlight-green tajwid tanwin1"), $(".arabic").highlight("ٌ" + t[i], "highlight-green tajwid tanwin1"), $(".arabic").highlight("ٍ " + t[i], "highlight-green tajwid tanwin2"), $(".arabic").highlight("ٍ" + t[i], "highlight-green tajwid tanwin2");
