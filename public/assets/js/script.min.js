		...
		vex.dialog.confirm({
		    ...
		    callback: function (value) {
		    	if(value==true){
					...
					$('.label-status-save').removeClass('mdi-lightbulb-on');
					$('.label-status-save').removeClass('mdi-lightbulb-outline');
					$.post(siteUrl+'/memoz/updateStatus',{
							...
							if(response.status==true){
								...
								if(response.status_memoz==0){
									$('.label-status-save').addClass('mdi-lightbulb-on');
								}else{
									$('.label-status-save').addClass('mdi-lightbulb-outline');
								}
