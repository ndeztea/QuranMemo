	...
	authProcess : function(){
		...
		$.post(this.siteUrl+'/auth/loginAction',{
					...
					if(response.login==true){
						...
						if(!jQuery('#errorLogin').hasClass('alert-danger')){
							jQuery('.modal-body').prepend('<p class="alert alert-danger" id="errorLogin" style="display:none"></p>');
						}
						jQuery('#errorLogin').html(response.errorMessage);
