...
<p><br>Screenshots QuranMemo <sup>Community</sup></p>
Daftar Hafalan
<img src="{{url('assets/images/dashboard.jpeg')}}" style="width:100%"><br>
Daftar Hafalan
<img src="{{url('assets/images/daftarhafalan.jpeg')}}" style="width:100%"><br>
Detail Hafalan
<img src="{{url('assets/images/hafalan.jpeg')}}" style="width:100%"><br>
