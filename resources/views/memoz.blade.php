			...
			<div class="col-xs-12">
				...
				<div class="mushaf mushaf-hafalan">
					<div class="pull-left step-wrap">
						...
						<div class="steps_desc"><p><i class="fa fa-info-circle"></i> Hafalkan dengan teliti target hafalan arabic dan terjemahannya,  jalankan dan dengarkan qori dengan teliti.</p></div>
					</div>
					<!-- /step-wrap -->
